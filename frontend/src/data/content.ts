...
// Every answer restates something the site already says elsewhere — delivery
// times come from `services[].items[].timeline`, the steps from the Process
// section, response time and the free first consultation from the contact
// modal and the CTA. No prices, no numbers of our own invention. Also emitted
// as FAQPage structured data on the home page, so keep it factual.
export const faq: FaqItem[] = [
  {
    q: "Сколько времени занимает разработка сайта?",
    a: "Лендинг — 7–14 дней, корпоративный сайт — 14–30 дней, интернет-магазин — 21–45 дней, web-приложение — от 30 дней. Точный срок называем после брифинга, когда понятен объём работ.",
  },
  {
    q: "Сколько стоит проект?",
    a: "Стоимость зависит от задач и объёма работ. После брифинга мы называем точную смету. Первая консультация — бесплатно.",
  },
  {
    q: "С чего начинается работа?",
    a: "С брифинга: изучаем ваш бизнес, цели, аудиторию и конкурентов. Затем готовим стратегию, визуальную концепцию и техническое задание — и переходим к реализации на согласованных этапах.",
  },
  {
    q: "Можно заказать только одну услугу?",
    a: "Да. Сайт, логотип, айдентику, ведение соцсетей или настройку рекламы можно заказать отдельно. А если нужно всё сразу — соберём комплексное решение.",
  },
  {
    q: "Вы работаете с компаниями из моей сферы?",
    a: "Среди наших клиентов — компании из самых разных ниш: медицина, e-commerce, рестораны, мебель и услуги. Каждому подбираем индивидуальный подход и стратегию роста.",
  },
  {
    q: "Что будет после запуска?",
    a: "Мы не просто запускаем, а сопровождаем проект: привлекаем клиентов, измеряем результат и помогаем масштабироваться.",
  },
  {
    q: "Как быстро вы отвечаете на заявку?",
    a: "В рабочее время — в течение пары часов. Позвоним, только если вы сами попросите.",
  },
]
